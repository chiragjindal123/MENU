...
# --- CONFIGURATION ---
SOURCE_DIR = "mixed_sign_classid_handwritten_dataset"  # Your existing folder
DEST_DIR = "mixed_sign_classid_handwritten_dataset_yolo_dataset" # New folder to be created
...
print("Done! Your data is ready in the 'mixed_sign_classid_handwritten_dataset_yolo_dataset' folder.")