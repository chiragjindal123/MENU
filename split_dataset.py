...
# --- CONFIGURATION ---
SOURCE_DIR = "overlap_img"  # Your existing folder
DEST_DIR = "overlap_img_yolo_dataset" # New folder to be created
...
print("Done! Your data is ready in the 'overlap_img_yolo_dataset' folder.")